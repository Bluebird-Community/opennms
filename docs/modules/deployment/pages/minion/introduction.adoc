...
Minions can operate behind a firewall and network address translation (NAT), as long as they can communicate with {page-component-title} via gRPC or an Apache Kafka message broker.
