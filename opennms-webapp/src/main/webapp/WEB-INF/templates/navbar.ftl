...
<nav class="navbar navbar-expand-md navbar-dark opennms-bg-chromatic-black" id="header" role="navigation">
    ...
    <a class="navbar-brand" href="${baseHref}index.jsp">
        <img id="logo" src="${baseHref}images/bluebird.svg" alt="Bluebird Logo" width="auto" height="42px"
             onerror="this.src='${baseHref}images/bluebird.png'"/>
    </a>
    <button type="button" title="Toggle navigation" class="navbar-toggler collapsed" data-toggle="collapse"
    ...
    <div id="navbar" class="navbar-collapse collapse">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a name="nav-help-top" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button"
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" name="nav-admin-api-documentation"
                       href="${baseHref}ui/index.html#/open-api">
                        <i class="fa fa-fw fa-info-circle"></i>&nbsp; API Documentation
                    </a>
                    <#if isAdmin >
                        <a class="dropdown-item" name="nav-admin-support" href="${baseHref}support/index.jsp"
                           title="Support">
            ...
            <li class="nav-item dropdown">
                <a name="nav-user-top" href="${baseHref}account/selfService/index.jsp" class="nav-link dropdown-toggle"
                   data-toggle="dropdown" role="button" aria-expanded="false">
                    <span class="fa fa-user"></span>
                    ${request.remoteUser}
                </a>
                <div class="dropdown-menu dropdown-menu-right" role="menu">
                    <a class="dropdown-item" name="nav-admin-self-service"
                       href="${baseHref}account/selfService/newPasswordEntry">
                        <i class="fa fa-key"></i>&nbsp; Change Password</a>
                    <form name="headerLogoutForm" action="${baseHref}j_spring_security_logout" method="post"></form>
                    <a class="dropdown-item" name="nav-admin-logout"
                       href="javascript:document.headerLogoutForm.submit()" style="white-space: nowrap">
