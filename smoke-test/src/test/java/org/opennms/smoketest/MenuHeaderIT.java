...
public class MenuHeaderIT extends OpenNMSSeleniumIT {
        ...
        public void testMenuEntries() throws Exception {
                // See opennms-webapp/src/main/webapp/WEB-INF/menu-template.json for the menu
                // template
                ...
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(
                                                By.xpath("//div[starts-with(@id, 'opennmsvaadinwallboard-')]")));

                frontPage();
                clickMenuItem("dashboardsMenu", "Heatmap");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//div[@class='card-header']/a[starts-with(text(), 'Alarm Heatmap')]")));

                clickMenuItem("dashboardsMenu", "Trends");
                wait.until(ExpectedConditions
                                .visibilityOfElementLocated(
                                                By.xpath("//div[@class='card-header']/span[text()='Trend']")));
                ...
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//div[@class='btn-toolbar']/span[text()='Nodes' or text()='Availability']")));

                clickMenuItem("inventoryMenu", "Assets");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//div[@id='content']//div[@class='card-header']/span[text()='Search Asset Information']")));

                clickMenuItem("inventoryMenu", "Search Inventory");
                wait.until(ExpectedConditions
                                .visibilityOfElementLocated(By
                                                .xpath("//div[@class='card-header']/span[text()='Search for Nodes']")));

                // Monitoring Menu
                clickMenuItem("monitoringMenu", "Applications");
                wait.until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("//li[text()='Application Status']")));

                clickMenuItem("monitoringMenu", "Alarms");
                wait.until(ExpectedConditions
                                .visibilityOfElementLocated(
                                                By.xpath("//div[@class='card-header']/span[text()='Alarm Queries']")));

                clickMenuItem("monitoringMenu", "Outages");
                wait.until(ExpectedConditions
                                .visibilityOfElementLocated(
                                                By.xpath("//div[@class='card-header']/span[text()='Outage Menu']")));

                clickMenuItem("monitoringMenu", "Events");
                wait.until(ExpectedConditions
                                .visibilityOfElementLocated(
                                                By.xpath("//div[@class='card-header']/span[text()='Event Queries']")));

                clickMenuItem("monitoringMenu", "Path Outages");
                wait.until(ExpectedConditions
                                .visibilityOfElementLocated(By
                                                .xpath("//div[@class='card-header']/span[text()='All Path Outages']")));
                ...
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Resource Graphs')]")));
                wait.until(ExpectedConditions.presenceOfElementLocated(
                                By.xpath("//label[contains(text()[normalize-space()], 'Standard Resource Performance Reports')]")));

                // Distributed Monitoring
                clickMenuItem("distributedMonitoringMenu", "Manage Minions");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Manage Minions')]")));

                clickMenuItem("distributedMonitoringMenu", "Manage Applications");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Applications')]")));
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(
                                                By.xpath("//div[@class='card-header']/span[text()='Applications']")));

                clickMenuItem("distributedMonitoringMenu", "Manage Monitoring Locations");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Monitoring Locations')]")));

                // Manage Inventory Menu
                clickMenuItem("manageInventoryMenu", "Provisioning Requisitions");
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                                "//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Provisioning Requisitions')]")));

                clickMenuItem("manageInventoryMenu", "Scheduled Node Discovery");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Modify Configuration')]")));

                clickMenuItem("manageInventoryMenu", "One-shot Node Discovery");
                wait.until(ExpectedConditions.visibilityOfElementLocated(By
                                .xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Create Discovery Scan')]")));

                // quick-add node screen
                clickMenuItem("manageInventoryMenu", "Add a Single Node");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Quick-Add Node')]")));

                clickMenuItem("manageInventoryMenu", "Delete Nodes");
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(
                                                By.xpath("//div[@class='card-header']/span[text()='Delete Nodes']")));

                clickMenuItem("manageInventoryMenu", "Manage Business Services");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Business Services')]")));
                frontPage();

                // User Management Menu
                clickMenuItem("userManagementMenu", "Manage Users");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'User List')]")));

                clickMenuItem("userManagementMenu", "Manage Groups");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Group List')]")));

                clickMenuItem("userManagementMenu", "Manage On-call Roles");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Role List')]")));

                // Integrations Menu
                clickMenuItem("integrationsMenu", "SNMP Agent Configuration");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Configure SNMP by IP')]")));

                clickMenuItem("integrationsMenu", "Geocoding Services");
                wait.until(ExpectedConditions.visibilityOfElementLocated(By
                                .xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Geocoder Configuration')]")));

                clickMenuItem("integrationsMenu", "Grafana PDF Reporting");
                wait.until(ExpectedConditions.visibilityOfElementLocated(By
                                .xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Endpoint Configuration')]")));
                ...
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'SNMP MIB Compiler')]")));

                clickMenuItem("toolsMenu", "JMX Metric Configuration Generator");
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                                "//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'JMX Configuration Generator')]")));

                clickMenuItem("toolsMenu", "Import/Export Node Asset Information");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Import/Export Assets')]")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//div[@class='card-header']/span[text()='Import and Export Assets']")));

                clickMenuItem("toolsMenu", "Send Custom Events");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Send Event')]")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//div[@class='card-header']/span[text()='Send Event to OpenNMS']")));

                // Administration Menu
                clickMenuItem("administrationMenu", "Surveillance Categories");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//div[@class='card-header']/span[text()='Surveillance Categories']")));

                clickMenuItem("administrationMenu", "Configure Thresholds");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//div[@class='card-header']/span[text()='Threshold Configuration']")));

                clickMenuItem("administrationMenu", "Flow Classification");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Flow Classification')]")));

                clickMenuItem("administrationMenu", "Notifications");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//div[@class='card-header']/span[text()='Notification queries']")));
                ...
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                                "//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Manage SNMP Collections and Data Collection Groups')]")));

                clickMenuItem("administrationMenu", "Manage SNMP Data Collection per Interface");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//div[@class='card-header']/span[text()='Manage SNMP Data Collection per Interface']")));

                clickMenuItem("administrationMenu", "Scheduled Outages");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Scheduled Outages')]")));
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(By
                                                .xpath("//div[@class='card-header']/h4[text()='Scheduled Outages']")));

                clickMenuItem("administrationMenu", "Wallboard Configuration");
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                                "//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Ops Board Configuration')]")));

                clickMenuItem("administrationMenu", "Product Update Enrollment");
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                                "//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Product Update Enrollment')]")));

                clickMenuItem("administrationMenu", "Configure OpenNMS");
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(
                                                By.xpath("//div[@class='card-header']/span[text()='OpenNMS System']")));
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(
                                                By.xpath("//div[@class='card-header']/span[text()='Provisioning']")));
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(By
                                                .xpath("//div[@class='card-header']/span[text()='Event Management']")));
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(By.xpath(
                                                "//div[@class='card-header']/span[text()='Service Monitoring']")));
                wait.until(ExpectedConditions.presenceOfElementLocated(
                                By.xpath("//div[@class='card-header']/span[text()='Performance Measurement']")));
                wait.until(ExpectedConditions.presenceOfElementLocated(
                                By.xpath("//div[@class='card-header']/span[text()='Distributed Monitoring']")));

                // Internal Logs Menu
                clickMenuItem("internalLogsMenu", "Instrumentation Log Reader");
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                                "//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Instrumentation Log Reader')]")));
                ...
                assertNotNull(foundElement, "apiDocumentationMenu / REST Open API Documentation");

                foundElement = findMenuItemLink("apiDocumentationMenu", "REST API Reference Documentation");
                assertNotNull(foundElement, "apiDocumentationMenu / REST API Reference Documentation");

                foundElement = findMenuItemLink("apiDocumentationMenu", "Source Code");
                assertNotNull(foundElement, "apiDocumentationMenu / Source Code");

                // Help Documentation menu
                clickMenuItem("helpDocumentationMenu", "Help");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Help')]")));
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(
                                                By.xpath("//div[@class='card-header']/span[text()='Documentation']")));

                clickMenuItem("helpDocumentationMenu", "About");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'About')]")));
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(By
                                                .xpath("//div[@class='card-header']/span[text()='Version Details']")));

                clickMenuItem("helpDocumentationMenu", "Support");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'Support')]")));
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(By.xpath(
                                                "//div[@class='card-header']/span[text()='Commercial Support']")));

                // Support Menu
                foundElement = findMenuItemLink("supportMenu", "Professional Support");
                assertNotNull(foundElement, "supportMenu / Professional Support");

                foundElement = findMenuItemLink("supportMenu", "Chat");
                assertNotNull(foundElement, "supportMenu / Chat");

                foundElement = findMenuItemLink("supportMenu", "Community Support (Discourse)");
                assertNotNull(foundElement, "supportMenu / Community Support (Discourse)");

                foundElement = findMenuItemLink("supportMenu", "Public Issue Tracker");
                assertNotNull(foundElement, "supportMenu / Public Issue Tracker");

                clickMenuItem("supportMenu", "Generate System Report");
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//ol[@class='breadcrumb']/li[contains(text()[normalize-space()], 'System Reports')]")));
                wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
                                "//div[@class='card-body']//div[@class='form-group']/input[@type='submit' and @value='Generate System Report']")));
                ...
                wait.until(
                                ExpectedConditions.presenceOfElementLocated(
                                                By.xpath("//div[contains(text(), 'Selection Context')]")));
                wait.until(
                                ExpectedConditions.presenceOfElementLocated(
                                                By.xpath("//div[starts-with(@id, 'opennmstopology-')]")));
                ...
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(By.xpath(
                                                "//div[@id='app']//div[@class='card']//span[text()='Node List']")));

                clickMenuItem("inventoryMenu", "Device Configs");
                wait.until(ExpectedConditions.presenceOfElementLocated(
                                By.xpath("//div[@id='app']//div[@class='link']/a[text()='Device Config Backup']")));
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(
                                                By.xpath("//div[@id='app']//span[text()='Device Configuration']")));

                clickMenuItem("toolsMenu", "Secure Credentials Vault");
                wait.until(ExpectedConditions.presenceOfElementLocated(
                                By.xpath("//div[@id='app']//div[@class='link']/a[text()='Secure Credentials Vault']")));
                wait.until(ExpectedConditions.presenceOfElementLocated(
                                By.xpath("//div[@id='app']//div[@class='scv-container']//p[text()='Add Credentials']")));
                ...
                // wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id='app']//span[text()='File
                // Editor']")));

                clickMenuItem("integrationsMenu", "External Requisitions");
                wait.until(ExpectedConditions.presenceOfElementLocated(
                                By.xpath("//div[@id='app']//div[@class='link']/a[text()='External Requisitions and Thread Pools']")));
                wait.until(ExpectedConditions.presenceOfElementLocated(
                                By.xpath("//div[@id='app']//h2[text()='External Requisitions and Thread Pools']")));

                clickMenuItem("administrationMenu", "Usage Statistics Sharing");
                wait.until(ExpectedConditions.presenceOfElementLocated(
                                By.xpath("//div[@id='app']//div[@class='link']/a[text()='Usage Statistics Collection']")));
                wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
                                "//div[@id='app']//div[@class='usage-stats-container']//span[text()='Usage Statistics Sharing']")));

                clickMenuItem("internalLogsMenu", "Log Viewer");
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(
                                                By.xpath("//div[@id='app']//div[@class='link']/a[text()='Logs']")));
                wait.until(
                                ExpectedConditions.presenceOfElementLocated(
                                                By.xpath("//div[@id='app']//div[@class='logs-sidebar']")));
                ...
                wait.until(ExpectedConditions
                                .presenceOfElementLocated(By.xpath("//div[@id='app']//div[@class='geo-map']")));

                // wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='api-title'
                // and contains(text()[normalize-space()], 'OpenNMS V2 RESTful API')]")));
        ...
        public void testSelfServiceMenu() {
                ...
                clickChangePassword();
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                                "//div[@class='card-header']/span[contains(text()[normalize-space()], 'Please enter the old and new passwords and confirm.')]")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//form[@name='goForm']//label[contains(text()[normalize-space()], 'Current Password')]")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("//form[@name='goForm']//label[contains(text()[normalize-space()], 'New Password')]")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(By
                                .xpath("//form[@name='goForm']//label[contains(text()[normalize-space()], 'Confirm New Password')]")));
        }
        ...
        public void verifyCentralSearch() {
                ...
                WebElement searchInput = findElementByXpath(
                                "//div[@id='onms-central-search-control']/div[@class='onms-search-input-wrapper']/input[@class='search-input']");
                searchInput.sendKeys("Configure");

                // Get the search result context header
                List<WebElement> searchHeaderResults = findElementsByXpath(
                                "//div[@id='onms-central-search-control']/div[@class='search-results-dropdown']/div[@class='search-category']");
                assertThat(searchHeaderResults.size(), is(1));

                List<WebElement> searchResultsHeaderElem = findElementsByXpath(
                                "//div[@id='onms-central-search-control']/div[@class='search-results-dropdown']/div[@class='search-category']/div[@class='onms-search-result-header']");
                ...
                List<WebElement> searchResultItems = findElementsByXpath(
                                "//div[@id='onms-central-search-control']/div[@class='search-results-dropdown']/div[@class='search-result-item']");
        ...
        // contains(text(),...) method does not work anymore
        private void clickMenuItemWithIcon(String menuEntryName, String submenuText, String submenuHref) {
                LoggerFactory.getLogger(getClass()).debug(
                                "clickMenuItemWithIcon: menuEntryName={}, submenuText={}, submenuHref={}",
                                menuEntryName, submenuText,
                                submenuHref);
                ...
                try {
                        ...
                        Unreliables.retryUntilSuccess((int) Duration.ofSeconds(30).getSeconds(), TimeUnit.SECONDS,
                                        () -> {
                                                ...
                                                final WebElement headerElement = findElementByXpath(
                                                                String.format("//li/a[@name='%s']", menuEntryName));

                                                // Move to element to make sub menu visible
                                                action.moveToElement(headerElement, offset.get(), offset.get())
                                                                .perform();
                                                ...
                                                final WebElement submenuElement = headerElement
                                                                .findElement(By.xpath(String.format(
                                                                                "./../div/a[contains(@class, 'dropdown-item') and contains(@href, '%s')]",
                                                                                submenuHref)));
