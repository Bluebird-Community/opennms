...
public class ClockSkewIT {
        ...
        public void verifyClockSkewDetection() throws Exception {
                ...
                final InetSocketAddress flowTelemetryAddress = stack.minion()
                                .getNetworkProtocolAddress(NetworkProtocol.FLOWS);
                ...
                // we need the host ip address in the docker network to be used as the exporter
                // address
                ...
                final OnmsNode onmsNode = await()
                                .atMost(Duration.ofMinutes(2)).pollInterval(Duration.ofSeconds(5))
                ...
                final OnmsAlarm onmsAlarm = await().atMost(Duration.ofMinutes(2)).pollInterval(Duration.ofSeconds(10))
