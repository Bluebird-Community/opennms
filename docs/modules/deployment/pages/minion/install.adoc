...
[[install-minion]]
= Install Minion
:description: How to install OpenNMS Minion on CentOS/RHEL 7-9, Debian/Ubuntu, Docker, and configure with message brokers: Kafka, gRPC.
...
* A Minion server can access the {page-component-title} Core gRPC server (`8990/tcp`) or the desired message broker nodes (for example, Apache Kafka `9092/tcp`).
...
+
--
include::centos-rhel10/install-minion.adoc[]
--
