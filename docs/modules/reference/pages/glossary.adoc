...
When using Minions and Sentinels, a transport is required for communication between servers.
Minions communicate with the {page-component-title} core instance over gRPC (the default) or an Apache Kafka cluster; Sentinels use Apache Kafka.
