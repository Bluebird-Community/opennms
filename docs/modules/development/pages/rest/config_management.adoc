...
The same schedule field is also editable from the web UI under menu:Info[External Requisitions], which exposes preset Daily, Weekly, and Monthly options plus an advanced field for raw expressions.
