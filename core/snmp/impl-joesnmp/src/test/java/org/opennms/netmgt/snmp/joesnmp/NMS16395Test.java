 ...
 * OpenNMS(R) is Copyright (C) 2026 The OpenNMS Group, Inc.
 *
...
public class NMS16395Test {
    private final static Function<String, AbstractSnmpValue> FUNCTION = string -> new JoeSnmpValue(new SnmpOctetString(string.getBytes()));
    ...
    public void testMappedCharacters() {
        System.setProperty(AbstractSnmpValue.ADDITIONAL_PRINTABLE_CHARACTERS_PROPERTY, "0x0a:0x20,0x45:0x58,0x11");
        AbstractSnmpValue.invalidateAdditionalCharacters();
