...
public class CollectorTokenAuthConfigurationTest extends XmlTestNoCastor<CollectorTokenAuthConfiguration> {

    public CollectorTokenAuthConfigurationTest(final CollectorTokenAuthConfiguration sampleObject,
    ...
    public static Collection<Object[]> data() {
        // Empty configuration.
        final CollectorTokenAuthConfiguration empty = new CollectorTokenAuthConfiguration();
        ...
        final CollectorTokenAuthConfiguration populated = new CollectorTokenAuthConfiguration();
        ...
        return Arrays.asList(new Object[][]{
                {
                        empty,
                        "<collector-token-auth-configuration xmlns=\"http://xmlns.opennms.org/xsd/config/collector-token-auth\"/>",
                        "target/classes/xsds/collector-token-auth-configuration.xsd"
                },
                {
                        populated,
                        "<collector-token-auth-configuration xmlns=\"http://xmlns.opennms.org/xsd/config/collector-token-auth\">"
