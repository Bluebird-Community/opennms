...
/**
 * This class can be used to generate uniformly-formatted queue/topic names
 * for usage in Java or Spring code. In the constructor, location is
...
public class JmsQueueNameFactory {
	 ...
	 * list so that you can easily use it in a Spring context.
	 */
