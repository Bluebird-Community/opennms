...
Starting with this release when upgrading OpenNMS, `custom.properties`, `config.properties` and `opennms.properties` files will be overridden.

=== Bug

* Adding IP Address Range to Discovery Fails (Issue https://issues.opennms.org/browse/NMS-18537[NMS-18537])
* Comma-separated categories enhancement tries to create empty Prometheus labels (Issue https://issues.opennms.org/browse/NMS-18976[NMS-18976])
* FE: Top menu can have 2 overlapping dropdowns for self-service and notifications (Issue https://issues.opennms.org/browse/NMS-18977[NMS-18977])
* Page Sequence Monitor invalid range spec for paramter response-range (Issue https://issues.opennms.org/browse/NMS-19008[NMS-19008])
* Path Traversal Allowing File Write Outside Intended Directory (Issue https://issues.opennms.org/browse/NMS-19045[NMS-19045])
* SNMP SET via minion fails - wrong XML adapter in SnmpSetRequestDTO (Issue https://issues.opennms.org/browse/NMS-19043[NMS-19043])
* Top nav bar style changes between classic and new UI pages (Issue https://issues.opennms.org/browse/NMS-15000[NMS-15000])
* Update com.fasterxml.jackson.core:jackson-core library (Issue https://issues.opennms.org/browse/NMS-18357[NMS-18357])
* Update cups-libs library (Issues https://issues.opennms.org/browse/NMS-18873[NMS-18873], https://issues.opennms.org/browse/NMS-18922[NMS-18922], https://issues.opennms.org/browse/NMS-18939[NMS-18939])
* Update io.grpc:grpc-netty-shaded library (Issue https://issues.opennms.org/browse/NMS-18782[NMS-18782])
* Update io.netty:netty-codec library (Issue https://issues.opennms.org/browse/NMS-18346[NMS-18346])
* Update io.netty:netty-codec-http library (Issue https://issues.opennms.org/browse/NMS-18347[NMS-18347])
* Update io.netty:netty-codec-smtp library (Issue https://issues.opennms.org/browse/NMS-19025[NMS-19025])
* Update jackson-databind library (Issue https://issues.opennms.org/browse/NMS-16675[NMS-16675])
* Update libarchive library (Issues https://issues.opennms.org/browse/NMS-18354[NMS-18354], https://issues.opennms.org/browse/NMS-18366[NMS-18366], https://issues.opennms.org/browse/NMS-18400[NMS-18400])
* Update pam library (Issues https://issues.opennms.org/browse/NMS-18367[NMS-18367], https://issues.opennms.org/browse/NMS-18381[NMS-18381], https://issues.opennms.org/browse/NMS-18401[NMS-18401])

=== Enhancement

* Allow users to control core services via environment variables (Issue https://issues.opennms.org/browse/NMS-18965[NMS-18965])
* Configurable structured logging output in JSON format (Issue https://issues.opennms.org/browse/NMS-19016[NMS-19016])
* Give SSLCertMonitor the option to resolve the server-name (Issue https://issues.opennms.org/browse/NMS-19078[NMS-19078])
* Improve ActiveMQ visualization (Issue https://issues.opennms.org/browse/NMS-19049[NMS-19049])

=== Story

* Always overwrite opennms.properties in upgrade process (Issue https://issues.opennms.org/browse/NMS-18201[NMS-18201])

=== Task

* FE: Menu template fix to remove unwanted menu header (Issue https://issues.opennms.org/browse/NMS-18773[NMS-18773])
* Update CentOS 9 install documentation (Issue https://issues.opennms.org/browse/NMS-18547[NMS-18547])
* Update Node List page documentation (Issue https://issues.opennms.org/browse/NMS-18534[NMS-18534])
