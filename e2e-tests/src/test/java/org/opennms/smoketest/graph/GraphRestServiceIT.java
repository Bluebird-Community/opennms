...
public class GraphRestServiceIT extends OpenNMSSeleniumIT {
    ...
    public void verifyContainerListInfos() {
        ...
        given().accept(ContentType.JSON).get()
                ...
                .body("[1].id", Matchers.is(CONTAINER_ID))
                .body("[1].label", Matchers.is(GRAPHML_TOPOLOGY_PROVIDER_LABEL))
                .body("[1].graphs.size()", Matchers.is(2))
                .body("[1].graphs[0].namespace", Matchers.is("acme:markets"))
                .body("[1].graphs[0].label", Matchers.is("Markets"))
                .body("[1].graphs[0].description", Matchers.is("The Markets Layer"))
                .body("[1].graphs[1].namespace", Matchers.is("acme:regions"))
                ;
    }
