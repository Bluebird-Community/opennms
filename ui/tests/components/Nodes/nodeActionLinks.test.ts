...
describe('nodeActionLinks', () => {
  ...
  // it is rendered.
  it('offers Schedule an Outage last', () => {
    expect(linkItems[linkItems.length - 1]).toEqual({ name: 'schedule-outage', label: 'Schedule an Outage' })
  })
